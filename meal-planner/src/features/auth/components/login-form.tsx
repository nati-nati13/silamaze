  ...
  return (
    <Card className="w-full max-w-md border-border/60 shadow-sm">
      <CardHeader className="pb-2 text-center">
        <p className="font-heading text-3xl font-bold tracking-widest text-foreground">
          DERMAKO
        </p>
        ...
        <p className="mt-4 font-heading text-xl font-semibold text-foreground">შესვლა</p>
